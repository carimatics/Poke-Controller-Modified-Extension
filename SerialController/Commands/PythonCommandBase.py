# for compatibility
from pokecontrollermodifiedextension.api.v0_1_8.command.commands.python.base import (  # noqa
...
# for compatibility
from pokecontrollermodifiedextension.api.v0_1_8.command.commands.python.decorators import ( # noqa
